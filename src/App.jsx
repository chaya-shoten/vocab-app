...
const extractWords = (text) => {
  const stopwords = new Set([
    "the", "and", "was", "for", "are", "but", "not", "you", "all", "any", "can", "had", "her", "his",
    "how", "man", "our", "out", "say", "she", "too", "use", "a", "an", "by", "do", "if", "in", "into",
    "is", "it", "no", "of", "on", "or", "such", "that", "their", "then", "there", "these", "they", "this",
    "to", "with", "would", "as", "at", "be", "have", "from", "including", "what", "due", "see"
  ]);
  return [...new Set(
...
const fetchWordData = async (word) => {
  try {
    ...
    console.error("❌ fetch error:", word, err);
    return {
      word,
...
export default function App() {
  ...
  return (
    <div style={{ padding: "20px", fontFamily: "sans-serif", maxWidth: 600, margin: "auto" }}>
      ...
      <button onClick={() => { setWords([]); setWordDataMap({}); setCurrentIndex(0); }}>進捗をリセット</button>
